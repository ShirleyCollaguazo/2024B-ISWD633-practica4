...
Como la Memoria swap máxima = memory-swap − memory = 1024 MB − 300 MB = 724 MB

Por lo tanto, el contenedor puede utilizar alrededor de 724 megabytes de memoria swap.
